...
public class MainActivity extends Activity
{
	...
	private class LevelListener implements ControlV1.LevelListener, Handler.Callback
	{
		...
		public void handleChannelDiscovery(Collection<Integer> channels)
		{
			for (int channel : channels)
			{
				...
				Message message = this.handler.obtainMessage(CHANNEL, channel, 0);
        ...
        public boolean handleMessage(Message msg)
        {
			...
			switch (msg.what)
			{
				case CHANNEL:
				{
					...
					this.layout.addView(view, msg.arg2);	
				}
				break;
